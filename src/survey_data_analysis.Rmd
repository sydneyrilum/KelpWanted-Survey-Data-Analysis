...
survey_data_tidy_sbv_long <- survey_data_tidy_sbv %>% 
  melt(id.vars = c("response_id", "response_type", "finished", "county", 
...
sbv_residents <- survey_data_tidy_sbv_long_filtered %>% 
  filter(question == "q2" | 
         question == "q4" |
         question == "q6" |
         question == "q8") %>%
...
# Specify categorical order of questions and answers
sbv_residents$answer <- factor(sbv_residents$answer, levels = c("Strongly opposed", 
                                                                                        "Somewhat opposed", 
                                                                                        "Neither opposed nor in support",
                                                                                        "Somewhat supportive",
                                                                                        "Strongly supportive"))
