...
ggplot(data = sex, 
  ...
  labs(x = "",
       y = "proportion of responses",
       title = "Relationship between sex and support of seaweed aquaculture") +
  theme_minimal() +
  theme(legend.title = element_blank(),
        legend.position = "right",
        axis.line.y = element_line(color = "black", size = 0.5),
...
ggplot(data = education, 
  ...
  labs(x = "",
       y = "proportion of responses",
       title = "Relationship between education and support of seaweed aquaculture") +
  theme_minimal() +
  theme(legend.title = element_blank(),
        legend.position = "right",
        axis.line.y = element_line(color = "black", size = 0.5),
...
ggplot(data = income, 
  ...
  labs(x = "",
       y = "proportion of responses",
       title = "Relationship between income and support of seaweed aquaculture") +
  theme_minimal() +
  theme(legend.title = element_blank(),
        legend.position = "right",
        axis.line.y = element_line(color = "black", size = 0.5),
...
ggplot(data = aq_industry, 
  ...
  labs(x = "",
       y = "proportion of responses",
       title = "Relation to aquaculture industry and support of seaweed aquaculture") +
  theme_minimal() +
  theme(legend.title = element_blank(),
        legend.position = "right",
        axis.line.y = element_line(color = "black", size = 0.5),
...
ggplot(data = county, 
  ...
  labs(x = "",
       y = "proportion of responses",
       title = "Relationship between county and support of seaweed aquaculture") +
  theme_minimal() +
  theme(legend.title = element_blank(),
        legend.position = "right",
        axis.line.y = element_line(color = "black", size = 0.5),
...
ggplot(data = age, 
  ...
  labs(x = "",
       y = "proportion of responses",
       title = "Relationship between age and support of seaweed aquaculture") +
  theme_minimal() +
  theme(legend.title = element_blank(),
        legend.position = "right",
        axis.line.y = element_line(color = "black", size = 0.5),
...
# Specify categorical order of questions and answers
occupation$answer <- factor(occupation$answer, levels = c("Strongly opposed", "Somewhat opposed", "Neither opposed nor in support","Somewhat supportive","Strongly supportive"))
...
ggplot(data = occupation, 
  ...
  labs(x = "",
       y = "proportion of responses",
       title = "Relationship between occupation sector and support of seaweed aquaculture") +
  theme_minimal() +
  theme(legend.title = element_blank(),
        legend.position = "right",
        axis.line.y = element_line(color = "black", size = 0.5),
