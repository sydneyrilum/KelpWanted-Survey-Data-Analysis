...
AND thus we can now group answers from Q2,4,6,8 together for further analyses, assuming that this combined data set reflects respondents support or opposition to the synonymous terms of kelp/seaweed aquauculture and kelp/seaweed farming.
