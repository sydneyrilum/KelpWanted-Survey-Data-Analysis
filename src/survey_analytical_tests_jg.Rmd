...
dependent variable = perception (q10)
independent variable = familiarity (Q13)
...
```{r create ordinal logistic model}
#use polr to create a logit model to understand how familiarity influences expansion
m3 <- polr(factor(q10) ~q13, data=ordinal_log_reg_3, Hess =TRUE)
summary(m3)
```
...
```{r predicted probabilities to understand odds ratio}
newdf3 <- data.frame(q13 =c(1, 2, 3, 4))
